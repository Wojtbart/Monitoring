...
const SECTIONS = [
    ...
    },
    {
        ...
        body: [
            ...
            "Na stronie historii temperatury/wilgotności: przekroczenie progu min/max zapala czerwony alarm (zostaje aż do ręcznego skasowania), przycisk \"Symuluj alarm (test)\" sprawdza czy powiadomienie faktycznie dochodzi.",
        ],
    },
    {
        ...
        body: [
            ...
            "Tabela reguł przypisuje grupę do zdarzenia (pożar/gaz/zalanie/drzwi/próg temp.-wilg. szafy) i włącza kanał (e-mail/SMS) osobno.",
            ...
            "SMS jest na razie zamockowany (log w konsoli backendu) — e-mail wymaga skonfigurowanego SMTP w `back/.env`.",
        ],
    },
    {
